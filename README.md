...
- **法律意见书审查** -- 以前版本只能审查合同，3.0 起新增了法律意见书审查。打开一份法律意见书点击审校，AI 会从 6 个维度帮你把关：结论是否用了绝对化表述（如"合法""无风险"）、引用的法条是否现行有效且精确到条款项、假设前提是否完整列出并区分了已核实和未核实的信息、免责声明是否涵盖了范围限制和第三方使用限制、文书结构是否完整（背景→分析→结论→免责）、格式是否统一规范
...
- **刑事自诉** -- 侮辱、诽谤、重婚、拒不执行判决等自诉案件
- **民事** -- 离婚、房屋买卖、租赁、物业、劳动争议、交通事故等
- **商事** -- 买卖合同、技术合同、借款、委托代理、知识产权、公司纠纷等
