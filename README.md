...
**不支持。**本插件采用微软官方最新的 Office Web Add-in（网页前端扩展）架构进行开发。目前，只有较新版本的官方 **Microsoft Word**（包括 Microsoft 365 订阅版、Word 2019/2021 等）支持这种先进的现代插件框架。WPS 暂无法运行此加载项，请更换到微软 Word 中使用。
